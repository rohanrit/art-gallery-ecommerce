          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 sm:grid-rows-3 gap-4 sm:gap-6 sm:min-h-[600px] lg:min-h-[700px]">
            {categories.map((category, index) => (
              <a
                key={category.id}
                href={`/${category.slug}`}
                className={`group relative overflow-hidden bg-charcoal shadow-sm rounded-lg ${
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6">
                  ...
                  <span className="inline-block mt-2 text-sm text-white/80 uppercase tracking-wider">
                    Shop Now
                  </span>
                </div>
              </a>
            ...
            {discount && (
              <a
                ...
                className="group relative overflow-hidden min-h-[200px] sm:min-h-0 sm:col-span-2 sm:col-start-1 sm:row-start-3 shadow-sm rounded-lg cursor-default"
                style={
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                  <p className="font-serif text-3xl sm:text-4xl text-white mb-2">
                    {discount.title}
                  </p>
                ...
                <button className="w-auto max-w-[250px] absolute bottom-3 left-3 right-3 bg-white/95 mx-auto text-charcoal text-sm font-medium py-2.5 uppercase tracking-wider opacity-25 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-400 ease-out hover:bg-primary hover:text-primary-foreground shadow-lg shadow-black/10">
